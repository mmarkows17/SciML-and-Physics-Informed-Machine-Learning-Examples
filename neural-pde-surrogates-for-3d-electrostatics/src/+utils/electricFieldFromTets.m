function out = electricFieldFromTets(nodes, elements, V)
%electricFieldFromTets Compute electric field from nodal potentials on tetrahedra.
%   out = electricFieldFromTets(nodes, elements, V) computes E = -grad(V)
%   on Tet4 or Tet10 meshes from MATLAB PDE Toolbox.
